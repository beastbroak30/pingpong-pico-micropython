...
# Set computer paddle parameters
computer_paddle_width = 25
computer_paddle_height = 6
computer_paddle_color = TFT.BLUE
...
# Initial computer paddle position
...
while True:
    ...
    if ball_x > computer_paddle_x + computer_paddle_width // 2:
        computer_paddle_x += computer_paddle_speed
    elif ball_x < computer_paddle_x + computer_paddle_width // 2:
        computer_paddle_x -= computer_paddle_speed

    # Limit the computer paddle within the screen boundaries
    computer_paddle_x = max(0, min(screen_width - computer_paddle_width, computer_paddle_x))
    ...
    if (
        ball_y - ball_radius <= computer_paddle_height
        and computer_paddle_x <= ball_x <= computer_paddle_x + computer_paddle_width
    ):
        ball_direction_y *= -1
    ...
    tft.fillrect((computer_paddle_x, 0), (computer_paddle_width, computer_paddle_height), computer_paddle_color)
